...
<div class="table-responsive">
    <div class="table-wrapper">
      <div class="table-title">
        <div class="row">
          <div class="col-sm-6">
            <h2><b>Imágenes del carousel</b></h2>
          </div>
          <div class="col-sm-6">
            <a href="/crearcarousel" class="btn btn-primary"><i class="fas fa-plus-circle"></i> <strong>Agregar</strong></a>       
          </div>
        </div>
      </div>
        ...
        <table class="table">
          ...
          @foreach($imagenesCarousel as $imagenCarousel)
          <tbody>
              <tr>
                  <th scope="row">{{$imagenCarousel['id']}}</th>
                  <td>{{$imagenCarousel['nombre']}}</td>
                  <td><img src="{{ asset('img/carousel/'.$imagenCarousel->id.'.jpg')}}" height="40" width="100"></td>
                  <td>{{$imagenCarousel['orden']}}</td>
                  <td>
                      <form action="carousel/{{$imagenCarousel->id}}/delete" method="POST">
                      @csrf
                      @method('DELETE')
                        <a href="/carousel/{{$imagenCarousel->id}}/editarcarousel" class="btn btn-success enlace">Editar</a>
