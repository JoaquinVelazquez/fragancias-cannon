...
<div class="table-responsive">
    <div class="table-wrapper">
      ...
      <form action="/destacados" method="POST">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            @foreach($perfumes as $perfume)
                <option value="{{$perfume->id}}" {{old('perfume_id') == $perfume->id ? 'selected' : ''}}>{{$perfume->nombre}}</option>
            @endforeach
            </select>
        </div>

        <div class="mb-3">
            <label for="orden" class="form-label">Seleccione Posición:</label>
            <select name="orden" id="orden" class="form-control">
                <option value="" selected disabled>Seleccione una opción</option>
                <option value="0" {{old('orden') === '0' ? 'selected' : ''}}>#1</option>
                <option value="1" {{old('orden') === '1' ? 'selected' : ''}}>#2</option>
                <option value="2" {{old('orden') === '2' ? 'selected' : ''}}>#3</option>
                <option value="3" {{old('orden') === '3' ? 'selected' : ''}}>#4</option>
                <option value="4" {{old('orden') === '4' ? 'selected' : ''}}>#5</option>
                <option value="5" {{old('orden') === '5' ? 'selected' : ''}}>#6</option>
                <option value="6" {{old('orden') === '6' ? 'selected' : ''}}>#7</option>
                <option value="7" {{old('orden') === '7' ? 'selected' : ''}}>#8</option>
                <option value="8" {{old('orden') === '8' ? 'selected' : ''}}>#9</option>
                <option value="9" {{old('orden') === '9' ? 'selected' : ''}}>#10</option>
                <option value="10" {{ old ('orden') === '10' ? 'selected' : ''}}>#11</option>
                <option value="11" {{ old ('orden') === '11' ? 'selected' : ''}}>#12</option>
                <option value="12" {{ old ('orden') === '12' ? 'selected' : ''}}>#13</option>
                <option value="13" {{ old ('orden') === '13' ? 'selected' : ''}}>#14</option>
                <option value="14" {{ old ('orden') === '14' ? 'selected' : ''}}>#15</option>
                <option value="15" {{ old ('orden') === '15' ? 'selected' : ''}}>#16</option>
                <option value="16" {{ old ('orden') === '16' ? 'selected' : ''}}>#17</option>
                <option value="17" {{ old ('orden') === '17' ? 'selected' : ''}}>#18</option>
                <option value="18" {{ old ('orden') === '18' ? 'selected' : ''}}>#19</option>
                <option value="19" {{ old ('orden') === '19' ? 'selected' : ''}}>#20</option>
            </select>
        </div>
          <div class="col-md-12">
          </div>
