...
<div class="table-responsive">
    <div class="table-wrapper">
      <div class="table-title">
        <div class="row">
          <div class="col-sm-6">
            <h2><b>Editar Presentación por Variedad</b></h2>
          </div>
        </div>
      </div>
      ...
      <form action="/presentacionesporvariedades/{{$presxvariedad->id}}/update" method="POST">
        @csrf
        @method('PUT')
        <div class="mb-3 d-flex" style="flex-direction: column;">
          ...
          <option value="" selected disabled>Seleccione una opción</option>
            ...
            <option value="{{$presentacion->id}}" @if($presentacion->id == $presxvariedad->presentacion->id) selected @endif>{{$presentacion->descripcion}}</option>
            @endforeach
          </select>
        </div>
        ...
        <div class="mb-3 d-flex" style="flex-direction: column;">
          ...
          <select name="vap" id="vap" class="form-control">
            <option value="" selected disabled>Seleccione una opción</option>
            <option value="1" @if($presxvariedad->vap) selected @endif>Si</option>
            <option value="0" @if(!($presxvariedad->vap)) selected @endif>No</option>
          </select>
        </div>
        ...
        <div class="mb-3 d-flex" style="flex-direction: column;">
          ...
          <select name="medida" id="medida" class="form-control">
            <option value="" selected disabled>Seleccione una opción</option>
            <option value="ml" @if($presxvariedad->medida == 'ml') selected @endif>ML</option>
            <option value="gs" @if($presxvariedad->medida == 'gs') selected @endif>GS</option>
            <option value="0" @if($presxvariedad->medida == '0') selected @endif>Ninguna</option>
          </select>
        </div>

        <div class="mb-3 d-flex" style="flex-direction: column;">
          <label for="vol" class="form-label">Volumen:</label>
          <input type="number" class="form-control" id="vol" name="vol" value="{{$presxvariedad->vol}}">
        </div>
