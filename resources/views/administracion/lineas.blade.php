    ...
    <div class="table-wrapper">
      <div class="table-title">
        <div class="row">
          ...
          <div class="col-sm-6">
            <a href="/crearlinea" class="btn btn-primary"><i class="fas fa-plus-circle"></i> <strong>Agregar</strong></a>      
          </div>
        </div>
      </div>
        ...
        <table class="table">
            ...
            <tbody>
                <tr>
                    ...
                    <td>{{$linea['nombre']}}</td>
                    <td>
                      <form action="lineas/{{$linea->id}}/delete" method="POST">
                      @csrf
                      @method('DELETE')
                        <a href="/lineas/{{$linea->id}}/editarlinea" class="btn btn-success enlace">Editar</a>
