    ...
    <div class="table-wrapper">
      <div class="table-title">
        <div class="row">
          ...
          <div class="col-sm-6">
            <a href="/crearmarca" class="btn btn-primary"><i class="fas fa-plus-circle"></i> <strong>Agregar</strong></a>      
          </div>
        </div>
      </div>
        ...
        <table class="table">
            ...
            <tbody>
                <tr>
                    ...
                    <td>{{$marca['nombre']}}</td>
                    <td>
                      <form action="marcas/{{$marca->id}}/delete" method="POST">
                      @csrf
                      @method('DELETE')
                        <a href="/marcas/{{$marca->id}}/editarmarca" class="btn btn-success enlace">Editar</a>
