...
<div class="table-responsive">
    <div class="table-wrapper">
      <div class="table-title">
        <div class="row">
          <div class="col-sm-6">
            <h2><b>Productos mas vendidos</b></h2>
          </div>
          <div class="col-sm-6">
          @if(count($masVendidos) <= 19)
            <a href="/creardestacado" class="btn btn-primary"><i class="fas fa-plus-circle"></i> <strong>Agregar</strong></a>
          @else
            <span class="btn btn-primary"><i class="fas fa-minus-circle"></i> <strong>Lista llena</strong></span>    
          @endif
          </div>
        </div>
      </div>
      ...
      <div class="col-md-12">
        ...
        <table class="table">
            ...
            <tbody>
                <tr>
                    <th scope="row">{{$masVendido['id']}}</th>
                    <td>{{$masVendido->perfume->nombre}}</td>
                    <td>#{{$masVendido['orden']+1}}</td>
                    <td>
                      <form action="destacados/{{$masVendido->id}}/delete" method="POST">
                      @csrf
                      @method('DELETE')
                        <a href="/destacados/{{$masVendido->id}}/editardestacado" class="btn btn-success enlace">Editar</a>
