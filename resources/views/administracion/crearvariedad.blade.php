...
<div class="table-responsive">
    <div class="table-wrapper">
      ...
      <form action="/variedades" method="POST">
        @csrf
        ...
        <div class="mb-3 d-flex" style="flex-direction: column;">
          <label for="codigo_catalogo" class="form-label">Codigo de catalogo:</label>
            <input type="text" class="form-control" id="codigo_catalogo" name="codigo_catalogo" value="{{old('codigo_catalogo')}}">
        </div>

        <div class="mb-3 d-flex" style="flex-direction: column;">
          <label for="codigo_ean" class="form-label">Codigo EAN:</label>
            <input type="text" class="form-control" id="codigo_ean" name="codigo_ean" value="{{old('codigo_ean')}}">
        </div>

        <div class="mb-3 d-flex" style="flex-direction: column;">
          <label for="precio" class="form-label">Precio:</label>
            <input type="number" class="form-control" id="precio" name="precio" min="0" value="{{old('precio')}}">
        </div>
        ...
        <div class="mb-3 d-flex" style="flex-direction: column;">
          <label for="activo" class="form-label">Limitado:</label>
            ...
            <option value="" disabled selected>Seleccione una opción</option>
            <option value="1" {{old('limited') === '1' ? 'selected' : ''}}>Si</option>
            <option value="0" {{old('limited') === '0' ? 'selected' : ''}}>No</option>
            </select>
        </div>
