...
<div class="table-responsive">
    <div class="table-wrapper">
      <div class="table-title">
        <div class="row">
          <div class="col-sm-6">
            <h2><b>Editar Imagen del Carousel</b></h2>
          </div>
        </div>
      </div>
      ...
      <form action="/carousel/{{$imagencarousel->id}}/update" method="POST">
        @csrf
        @method('PUT')
        <div class="mb-3">
          <label for="nombre" class="form-label">Nombre:</label>
          <input type="text" class="form-control" id="nombre" name="nombre" value="{{$imagencarousel->nombre}}">
        </div>

        <div class="mb-3">
          <label for="link" class="form-label">Link:</label>
          <input type="text" class="form-control" id="link" name="link" value="{{$imagencarousel->link}}">
        </div>

        <div class="mb-3">
          <label for="orden" class="form-label">Orden:</label>
          <input type="number" class="form-control" id="orden" name="orden" min="1" value="{{$imagencarousel->orden}}">
        </div>

        <div class="pt-2 pb-4 d-flex" style="flex-direction: column;">
            <span>Imagen Actual</span>
            <img src="{{ asset('img/carousel/'.$imagencarousel->id.'.jpg')}}" height="200" width="500">
        </div>

        <button type="submit" class="btn btn-primary">Actualizar</button>
        <a href="/carousel" class="btn btn-danger">Cancelar</a>
      </form>
