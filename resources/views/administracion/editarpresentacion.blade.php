...
<div class="table-responsive">
    <div class="table-wrapper">
      ...
      <form action="/presentaciones/{{$presentacion->id}}/update" method="POST">
        @csrf
        @method('PUT')
        <div class="mb-3">
          <label for="descripcion" class="form-label">Descripción:</label>
          <input type="text" class="form-control" id="descripcion" name="descripcion" value="{{$presentacion['descripcion']}}">
        </div>
        <button type="submit" class="btn btn-primary">Actualizar</button>
        <a href="/presentaciones" class="btn btn-danger">Cancelar</a>
      </form>
