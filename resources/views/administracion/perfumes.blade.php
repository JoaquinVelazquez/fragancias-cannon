    ...
    <div class="table-wrapper">
      <div class="table-title">
        <div class="row">
          ...
          <div class="col-sm-6">
            <a href="/crearperfume" class="btn btn-primary"><i class="fas fa-plus-circle"></i> <strong>Agregar</strong></a>      
          </div>
        </div>
      </div>
        ...
        <table class="table">
            ...
            <tbody>
                <tr>
                    ...
                    <td>{{$perfume['fragancia']}}</td>
                    <td>{{$perfume->linea->nombre}}</td>
                    <td>{{$perfume->marca->nombre}}</td>
                    <td>{{$perfume['is_premium']}}</td>
                    <td>{{$perfume['facebook']}}</td>
                    <td>{{$perfume['instagram']}}</td>
                    <td>{{$perfume['orden']}}</td>
                    <td>
                    <form action="perfumes/{{$perfume->id}}/delete" method="POST">
                    @csrf
                    @method('DELETE')
                        <a href="/perfumes/{{$perfume->id}}/editarperfume" class="btn btn-success enlace">Editar</a>
