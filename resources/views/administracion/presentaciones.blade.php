...
<div class="table-responsive">
    <div class="table-wrapper">
      <div class="table-title">
        <div class="row">
          <div class="col-sm-6">
            <h2><b>Presentaciones</b></h2>
          </div>
          <div class="col-sm-6">
            <a href="/crearpresentacion" class="btn btn-primary"><i class="fas fa-plus-circle"></i> <strong>Agregar</strong></a>      
          </div>
        </div>
      </div>
        ...
        <table class="table">
            ...
            <tbody>
                <tr>
                    <th scope="row">{{$presentacion['id']}}</th>
                    <td>{{$presentacion['descripcion']}}</td>
                    <td>
                    <form action="presentaciones/{{$presentacion->id}}/delete" method="POST">
                      @csrf
                      @method('DELETE')
                        <a href="/presentaciones/{{$presentacion->id}}/editarpresentacion" class="btn btn-success enlace">Editar</a>
