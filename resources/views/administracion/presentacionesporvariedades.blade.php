...
<div class="table-responsive">
    <div class="table-wrapper">
      <div class="table-title">
        <div class="row">
          <div class="col-sm-6">
            <h2><b>Presentaciones por variedad</b></h2>
          </div>
          <div class="col-sm-6">
            <a href="/crearpresentacionporvariedad" class="btn btn-primary"><i class="fas fa-plus-circle"></i> <strong>Agregar</strong></a>      
          </div>
        </div>
      </div>
        ...
        <table class="table">
            ...
            <thead>
                <tr>
                    ...
                    <th scope="col">Variedad ID</th>
                    <th scope="col">Vaporizador</th>
                    <th scope="col">Medida</th>
                    <th scope="col">Volumen</th>
                    <th scope="col">Administrar</th>
                </tr>
            </thead>
            @foreach($presxvariedades as $presxvariedad)
            <tbody>
                <tr>
                    <td scope>{{$presxvariedad->id}}</td>
                    <td>{{$presxvariedad->presentacion->descripcion}}</td>
                    <td>{{$presxvariedad->variedad->id}}</td>
                    <td>{{$presxvariedad['vap']}}</td>
                    <td>{{$presxvariedad['medida']}}</td>
                    <td>{{$presxvariedad['vol']}}</td>
                    <td>
                      <form action="presentacionesporvariedades/{{$presxvariedad->id}}/delete" method="POST">
                      @csrf
                      @method('DELETE')
                        <a href="presentacionesporvariedades/{{$presxvariedad->id}}/editarpresentacionporvariedad" class="btn btn-success enlace">Editar</a>
