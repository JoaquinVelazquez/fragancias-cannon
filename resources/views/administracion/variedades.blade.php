    ...
    <div class="table-wrapper">
      <div class="table-title">
        <div class="row">
          ...
          <div class="col-sm-6">
            <a href="/crearvariedad" class="btn btn-primary"><i class="fas fa-plus-circle"></i> <strong>Agregar</strong></a>      
          </div>
        </div>
      </div>
        ...
        <table class="table">
            ...
            <thead>
                <tr>
                    ...
                    <th scope="col">Codigo Catalogo</th>
                    <th scope="col">Codigo EAN</th>
            ...
            <tbody>
                <tr>
                    <th scope="row">{{$variedad['id']}}</th>
                    <td>{{$variedad->perfume->nombre}}</td>
                    <td>{{$variedad['codigo_catalogo']}}</td>
                    <td>{{$variedad['codigo_ean']}}</td>
                    <td>${{$variedad['precio']}}</td>
                    <td>{{$variedad['orden']}}</td>
                    <td>{{$variedad['activo']}}</td>
                    <td>{{$variedad['limited']}}</td>
                    <td>
                      <form action="variedades/{{$variedad->id}}/delete" method="POST">
                      @csrf
                      @method('DELETE')
                        <a href="/variedades/{{$variedad->id}}/editarvariedad" class="btn btn-success enlace">Editar</a>
